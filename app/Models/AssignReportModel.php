...
class AssignReportModel extends Model
{
    ...
    {
        $query = $this->db->query("SELECT assign_report_details.id, assign_report_details.fnsku, assign_report_details.item_check, assign_report_box.box_note, assign_report_box.promocode_id, assign_report_box.category, assign_report_box.description, assign_report_box.fba_number, assign_report_box.shipment_number, assign_report_box.status, sku, item_description, cond, qty, retail, original, cost, vendor, item_note, item_status FROM box_sum RIGHT JOIN assign_report_details ON assign_report_details.box_name = box_sum.box_name JOIN assign_report_box ON assign_report_details.box_name = assign_report_box.box_name WHERE assign_report_box.box_name ='$box_name' ");
        return $query;
    }

    public function getBoxSummaryHistory($box_name)
    {
        $query = $this->db->query("SELECT assign_report_details.id, assign_report_details.fnsku, assign_report_details.item_check, assign_report_box.box_note, assign_report_box.promocode_id, assign_report_box.category, assign_report_box.description, assign_report_box.fba_number, assign_report_box.shipment_number, assign_report_box.status, assign_report_details.sku, assign_report_details.item_description, assign_report_details.cond, assign_report_details.qty, assign_report_details.retail, assign_report_details.original, assign_report_details.cost, assign_report_details.vendor, item_note, item_status FROM box_sum RIGHT JOIN assign_report_details ON assign_report_details.box_name = box_sum.box_name JOIN assign_report_box ON assign_report_details.box_name = assign_report_box.box_name JOIN reports ON reports.sku = assign_report_details.sku WHERE assign_report_box.box_name ='$box_name' GROUP BY assign_report_details.sku; ");
        return $query;
    }
