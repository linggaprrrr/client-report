...
class API extends ResourceController
{
            ...
            if (isset($_GET['code']) || (isset($_SESSION['access_token']) && $_SESSION['access_token'])) {
                if (isset($_GET['code'])) {
                    ...
                    foreach($drives as $drv) {
                        do {
                            $response = $driveService->files->listFiles(array(                            
                                'q' => "'" .$drv['id']. "' in parents and mimeType='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' and modifiedTime > '".date('Y-m-d', strtotime('-1 days'))."T12:00:00'",
                                'spaces' => 'drive',
                                'pageToken' => $pageToken,
                                'fields' => 'nextPageToken, files(id, name)',
                            ));                        
    ...
    public function costLeftClient() {
    ...
    public function test() {
        $mail = new PHPMailer;
        // p&l
//         $message = '<div><table style="background-color:#ffffff;padding-top:20px;color:#434245;width:100%;border:0;text-align:center;border-collapse:collapse" class="m_-3284274901574111302background_main"><tbody><tr><td style="vertical-align:top;padding:0"><center><table id="m_-3284274901574111302body" style="border:0;border-collapse:collapse;margin:0 auto;background:white;border-radius:8px;margin-bottom:16px"><tbody><tr><td style="width:546px;vertical-align:top;padding-top:32px"><div style="max-width:600px;margin:0 auto"><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><div style="margin-top:18px" class=""></div><h1>Hi, JLM Emporium (Elite) <img src="https://ci3.googleusercontent.com/proxy/Fs2AhUjffUUKf86AB2mdll9m_5Iv48fOEF3Tqk6YleLCs0SzLxmRnPrQQ2vo8F7AMRJecQz115N63XjDmYwBocgcMVJuRgnaMb24CVnhD1b534kpJPc=s0-d-e1-ft#https://a.slack-edge.com/80588/img/emoji_2017_12_06/apple/1f44b.png" width="30" height="30" alt="wave emoji" class="CToWUd" data-bit="iit"></h1><p style="font-size:20px;line-height:28px;letter-spacing:-0.2px;margin-bottom:28px;word-break:break-word" class="m_-3284274901574111302hero_paragraph">Your P&amp;L has been updated, please check through the app</p><table style="width:100%"><tbody><tr style="width:100%"><td style="width:100%"><span style="display:inline-block;border-radius:4px;background-color:#611f69;width:100%;text-align:center" class="m_-3284274901574111302button_link_wrapper m_-3284274901574111302plum"><a class="m_-3284274901574111302button_link m_-3284274901574111302plum m_-3284274901574111302restyle_button" href="https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT" style="border-top:13px solid;border-bottom:13px solid;border-right:24px solid;border-left:24px solid;/* border-color:#611f69; */border-radius:4px;background-color: #e36743;color:#ffffff;font-size:16px;line-height:18px;word-break:break-word;font-weight:bold;font-size:14px;border-top:20px solid;border-bottom:20px solid;border-color: #e36743;line-height:14px;letter-spacing:0.8px;text-transform:uppercase;box-sizing:border-box;width:100%;text-align:center;display:inline-block;text-align:center;font-weight:900;text-decoration:none!important" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT&amp;source=gmail&amp;ust=1678505058793000&amp;usg=AOvVaw2OuipL20flZUB50JmeTKZj">Open Elite App</a></span></td></tr></tbody></table></div><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><table style="margin:0 auto;width:100%"><tbody><tr><td style="box-sizing:border-box;padding:0;width:100%;margin:0 auto"><hr>
// </td></tr></tbody></table></div></div></td></tr></tbody></table></center></td></tr><tr><td class="m_-3284274901574111302email_footer" style="font-size:15px;color:#717274;text-align:center;width:100%"><center><table style="background-color:white;border:0;text-align:center;border-collapse:collapse"><tbody><tr><td style="width:546px;vertical-align:top;padding:0px"><div style="max-width:600px;margin:0 auto"><div style="padding:0 50px"><table><tbody><tr><td style="text-align:left"><img width="" height="24" style="margin-top:0;margin-right:0;margin-bottom:32px;margin-left:0px" src="https://elite-automation.com/wp-content/uploads/2021/06/logo1_clr-1.png" alt="slack logo" class="CToWUd" data-bit="iit"></td></tr></tbody></table><div style="font-size:12px;opacity:0.5;color:#696969;text-align:left;line-height:15px;margin-bottom:50px;text-align:left"><div>Elite Automation is the premier provider in Amazon FBA Automation. Our team has the experience and expertise to provide unparalled service to our clients.<br></div><br>All rights reserved.</div></div></div></td></tr></tbody></table></center></td></tr></tbody></table></div>';

            // $message = '<div class=""><div class="aHl"></div><div id=":ms" tabindex="-1"></div><div id=":mh" class="ii gt" jslog="20277; u014N:xr6bB; 1:WyIjdGhyZWFkLWY6MTc1OTM1MjM5Mjk1NzIyMDEyMiIsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsW11d; 4:WyIjbXNnLWY6MTc1OTM1MjM5Mjk1NzIyMDEyMiIsbnVsbCxbXV0."><div id=":mg" class="a3s aiL msg-3284274901574111302"><u></u><div><table style="background-color:#fff;padding-top:20px;color:#434245;width:100%;border:0;text-align:center;border-collapse:collapse" class="m_-3284274901574111302background_main"><tbody><tr><td style="vertical-align:top;padding:0"><center><table id="m_-3284274901574111302body" style="border:0;border-collapse:collapse;margin:0 auto;background:#fff;border-radius:8px;margin-bottom:16px"><tbody><tr><td style="width:546px;vertical-align:top;padding-top:32px"><div style="max-width:600px;margin:0 auto"><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><div style="margin-top:18px" class=""></div><h1>Hi, Amazing Products Sold (SFBA) <img src="https://ci3.googleusercontent.com/proxy/Fs2AhUjffUUKf86AB2mdll9m_5Iv48fOEF3Tqk6YleLCs0SzLxmRnPrQQ2vo8F7AMRJecQz115N63XjDmYwBocgcMVJuRgnaMb24CVnhD1b534kpJPc=s0-d-e1-ft#https://a.slack-edge.com/80588/img/emoji_2017_12_06/apple/1f44b.png" width="30" height="30" alt="wave emoji" class="CToWUd" data-bit="iit"></h1><p style="font-size:20px;line-height:28px;letter-spacing:-.2px;margin-bottom:28px;word-break:break-word" class="m_-3284274901574111302hero_paragraph">Your P&amp;L has been updated, please check through the app</p><table style="width:100%"><tbody><tr style="width:100%"><td style="width:100%"><span style="display:inline-block;border-radius:4px;background-color:#611f69;width:100%;text-align:center" class="m_-3284274901574111302button_link_wrapper m_-3284274901574111302plum"><a class="m_-3284274901574111302button_link m_-3284274901574111302plum m_-3284274901574111302restyle_button" href="https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT" style="border-top:13px solid;border-bottom:13px solid;border-right:24px solid;border-left:24px solid;border-radius:4px;background-color:#1d59a9;color:#fff;font-size:16px;line-height:18px;word-break:break-word;font-weight:700;font-size:14px;border-top:20px solid;border-bottom:20px solid;border-color:#1d59a9;line-height:14px;letter-spacing:.8px;text-transform:uppercase;box-sizing:border-box;width:100%;text-align:center;display:inline-block;text-align:center;font-weight:900;text-decoration:none!important" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT&amp;source=gmail&amp;ust=1678505058793000&amp;usg=AOvVaw2OuipL20flZUB50JmeTKZj">Open SWClient App</a></span></td></tr></tbody></table></div><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><table style="margin:0 auto;width:100%"><tbody><tr><td style="box-sizing:border-box;padding:0;width:100%;margin:0 auto"><hr></td></tr></tbody></table></div></div></td></tr></tbody></table></center></td></tr><tr><td class="m_-3284274901574111302email_footer" style="font-size:15px;color:#717274;text-align:center;width:100%"><center><table style="background-color:#fff;border:0;text-align:center;border-collapse:collapse"><tbody><tr><td style="width:546px;vertical-align:top;padding:0"><div style="max-width:600px;margin:0 auto"><div style="padding:0 50px"><table><tbody><tr><td style="text-align:left"><img width="" height="56px" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0" src="https://swclient.site/assets/images/fba-logo.png" alt="slack logo" class="CToWUd" data-bit="iit"></td></tr></tbody></table><div style="font-size:12px;opacity:.5;color:#696969;text-align:left;line-height:15px;margin-bottom:50px;text-align:left"><div>Smart FBA is an Amazon Automation provider which utilizes the wholesale model. We purchase items in build, and get clients approved for restricted brands, which allows for as much growth as possible within the FBA model.<br></div><br>All rights reserved.</div></div></div></td></tr></tbody></table></center></td></tr></tbody></table></div></div><div class="yj6qo"></div></div><div id=":mw" class="ii gt" style="display:none"><div id=":mx" class="a3s aiL"></div></div><div class="hi"></div></div>';

        // reach 500
//         $message = '<div><table style="background-color:#ffffff;padding-top:20px;color:#434245;width:100%;border:0;text-align:center;border-collapse:collapse" class="m_-3284274901574111302background_main"><tbody><tr><td style="vertical-align:top;padding:0"><center><table id="m_-3284274901574111302body" style="border:0;border-collapse:collapse;margin:0 auto;background:white;border-radius:8px;margin-bottom:16px"><tbody><tr><td style="width:546px;vertical-align:top;padding-top:32px"><div style="max-width:600px;margin:0 auto"><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><div style="margin-top:18px" class=""></div><h1>Hi, JLM Emporium (Elite) <img src="https://ci3.googleusercontent.com/proxy/Fs2AhUjffUUKf86AB2mdll9m_5Iv48fOEF3Tqk6YleLCs0SzLxmRnPrQQ2vo8F7AMRJecQz115N63XjDmYwBocgcMVJuRgnaMb24CVnhD1b534kpJPc=s0-d-e1-ft#https://a.slack-edge.com/80588/img/emoji_2017_12_06/apple/1f44b.png" width="30" height="30" alt="wave emoji" class="CToWUd" data-bit="iit"></h1><p style="font-size:20px;line-height:28px;letter-spacing:-0.2px;margin-bottom:28px;word-break:break-word;text-align: justify;" class="m_-3284274901574111302hero_paragraph">Your Manifest is Almost Completed. Time to re-order, please go to Purchase Inventory to order more</p><table style="width:100%"><tbody><tr style="width:100%"><td style="width:100%"><span style="display:inline-block;border-radius:4px;background-color:#611f69;width:100%;text-align:center" class="m_-3284274901574111302button_link_wrapper m_-3284274901574111302plum"><a class="m_-3284274901574111302button_link m_-3284274901574111302plum m_-3284274901574111302restyle_button" href="https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT" style="border-top:13px solid;border-bottom:13px solid;border-right:24px solid;border-left:24px solid;/* border-color:#611f69; */border-radius:4px;background-color: #e36743;color:#ffffff;font-size:16px;line-height:18px;word-break:break-word;font-weight:bold;font-size:14px;border-top:20px solid;border-bottom:20px solid;border-color: #e36743;line-height:14px;letter-spacing:0.8px;text-transform:uppercase;box-sizing:border-box;width:100%;text-align:center;display:inline-block;text-align:center;font-weight:900;text-decoration:none!important" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT&amp;source=gmail&amp;ust=1678505058793000&amp;usg=AOvVaw2OuipL20flZUB50JmeTKZj">Open Elite App</a></span></td></tr></tbody></table></div><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><table style="margin:0 auto;width:100%"><tbody><tr><td style="box-sizing:border-box;padding:0;width:100%;margin:0 auto"><hr>
// </td></tr></tbody></table></div></div></td></tr></tbody></table></center></td></tr><tr><td class="m_-3284274901574111302email_footer" style="font-size:15px;color:#717274;text-align:center;width:100%"><center><table style="background-color:white;border:0;text-align:center;border-collapse:collapse"><tbody><tr><td style="width:546px;vertical-align:top;padding:0px"><div style="max-width:600px;margin:0 auto"><div style="padding:0 50px"><table><tbody><tr><td style="text-align:left"><img width="" height="24" style="margin-top:0;margin-right:0;margin-bottom:32px;margin-left:0px" src="https://elite-automation.com/wp-content/uploads/2021/06/logo1_clr-1.png" alt="slack logo" class="CToWUd" data-bit="iit"></td></tr></tbody></table><div style="font-size:12px;opacity:0.5;color:#696969;text-align:left;line-height:15px;margin-bottom:50px;text-align:left"><div>Elite Automation is the premier provider in Amazon FBA Automation. Our team has the experience and expertise to provide unparalled service to our clients.<br></div><br>All rights reserved.</div></div></div></td></tr></tbody></table></center></td></tr></tbody></table></div>';

        $message = '<div><table style="background-color:#fff;padding-top:20px;color:#434245;width:100%;border:0;text-align:center;border-collapse:collapse" class="m_-3284274901574111302background_main"><tbody><tr><td style="vertical-align:top;padding:0"><center><table id="m_-3284274901574111302body" style="border:0;border-collapse:collapse;margin:0 auto;background:#fff;border-radius:8px;margin-bottom:16px"><tbody><tr><td style="width:546px;vertical-align:top;padding-top:32px"><div style="max-width:600px;margin:0 auto"><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><div style="margin-top:18px" class=""></div><h1>Hi, Amazing Products Sold (SFBA) <img src="https://ci3.googleusercontent.com/proxy/Fs2AhUjffUUKf86AB2mdll9m_5Iv48fOEF3Tqk6YleLCs0SzLxmRnPrQQ2vo8F7AMRJecQz115N63XjDmYwBocgcMVJuRgnaMb24CVnhD1b534kpJPc=s0-d-e1-ft#https://a.slack-edge.com/80588/img/emoji_2017_12_06/apple/1f44b.png" width="30" height="30" alt="wave emoji" class="CToWUd" data-bit="iit"></h1><p style="font-size:20px;line-height:28px;letter-spacing:-.2px;margin-bottom:28px;word-break:break-word;text-align:justify" class="m_-3284274901574111302hero_paragraph">Your Last Manifest is Almost Completed. Time to re-order, please go to Purchase Inventory to order more</p><table style="width:100%"><tbody><tr style="width:100%"><td style="width:100%"><span style="display:inline-block;border-radius:4px;background-color:#611f69;width:100%;text-align:center" class="m_-3284274901574111302button_link_wrapper m_-3284274901574111302plum"><a class="m_-3284274901574111302button_link m_-3284274901574111302plum m_-3284274901574111302restyle_button" href="https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT" style="border-top:13px solid;border-bottom:13px solid;border-right:24px solid;border-left:24px solid;border-radius:4px;background-color:#1d59a9;color:#fff;font-size:16px;line-height:18px;word-break:break-word;font-weight:700;font-size:14px;border-top:20px solid;border-bottom:20px solid;border-color:#1d59a9;line-height:14px;letter-spacing:.8px;text-transform:uppercase;box-sizing:border-box;width:100%;text-align:center;display:inline-block;text-align:center;font-weight:900;text-decoration:none!important" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://smartwholesal-ndj8403.slack.com/x-p2788623983059-4560040714915-4892727880467/archives/D04S5T1P8MT&amp;source=gmail&amp;ust=1678505058793000&amp;usg=AOvVaw2OuipL20flZUB50JmeTKZj">Open SWClient App</a></span></td></tr></tbody></table></div><div style="margin-left:50px;margin-right:50px;margin-bottom:72px;margin-bottom:30px" class="m_-3284274901574111302lg_margin_left_right m_-3284274901574111302xl_margin_bottom"><table style="margin:0 auto;width:100%"><tbody><tr><td style="box-sizing:border-box;padding:0;width:100%;margin:0 auto"><hr></td></tr></tbody></table></div></div></td></tr></tbody></table></center></td></tr><tr><td class="m_-3284274901574111302email_footer" style="font-size:15px;color:#717274;text-align:center;width:100%"><center><table style="background-color:#fff;border:0;text-align:center;border-collapse:collapse"><tbody><tr><td style="width:546px;vertical-align:top;padding:0"><div style="max-width:600px;margin:0 auto"><div style="padding:0 50px"><table><tbody><tr><td style="text-align:left"><img width="" height="56px" style="margin-top:0;margin-right:0;margin-bottom:0;margin-left:0" src="https://swclient.site/assets/images/fba-logo.png" alt="slack logo" class="CToWUd" data-bit="iit"></td></tr></tbody></table><div style="font-size:12px;opacity:.5;color:#696969;text-align:left;line-height:15px;margin-bottom:50px;text-align:left"><div>Smart FBA is an Amazon Automation provider which utilizes the wholesale model. We purchase items in build, and get clients approved for restricted brands, which allows for as much growth as possible within the FBA model.<br></div><br>All rights reserved.</div></div></div></td></tr></tbody></table></center></td></tr></tbody></table></div>';
        ...
        $mail->Port = 587;
        $mail->SMTPAuth = true;
        $mail->Subject = 'Your Manifest Almost Completed - Smart FBA Inc.';
        $mail->Username = 'noreply.info@swclient.site';
        $mail->Password = 'swclientinfo1';
        $mail->setFrom('noreply.info@swclient.site', 'Smart FBA Inc.');
        $mail->addAddress('lingga@buysmartwholesale.com', 'Ling');
