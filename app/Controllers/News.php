...
class News extends BaseController
{
    ...
    public function pushNotification() {
        ...
        curl_close($curl);
        $curl = curl_init();
        $authKey = "key=AAAAVhrBtck:APA91bH2ha8ZJikvZXgYw65CKM33s1E-2hpYOHrfnBxTNyjpSI4ggXg_n71WoVqKRUtCwmDWhMeYtF6dBK_OvJt5XIHR9N5yO-_J7-4cM47AX9Rm0C6nQyNRMN8icPPkxWI2__EXC_ya";
        $registration_ids = json_encode($regists);
        print_r($registration_ids);
