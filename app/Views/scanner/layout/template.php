...
<head>
    <?= $this->include('scanner/layout/header'); ?>
    <title><?= $tittle ?></title>
...
<body>
    <!-- Main navbar -->
    <?= $this->include('scanner/layout/main-navbar') ?>
    <!-- /main navbar -->
    ...
    <div class="page-content">
        <!-- Main sidebar -->
        <?= $this->include('scanner/layout/sidebar') ?>
        <!-- /main sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                <?= $this->include('scanner/layout/footer') ?>
            </div>
        </div>
        <?= $this->include('scanner/layout/notif') ?>
</body>
