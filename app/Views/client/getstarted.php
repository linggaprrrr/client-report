    ...
    <div class="card">
        <div class="card-body">
            <span>
                ...
                <p class="text-justify">Before you do any purchase of inventory or brand approvals we <b>HIGHLY</b> recommend watching this video about the process and expectations for this business. We are <b>NOT</b> a get rich quick scheme nor are we here to promise the unrealistic. Building an Amazon FBA store takes time and patience. </p>
                <br>
