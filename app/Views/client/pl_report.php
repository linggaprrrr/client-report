                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="chart-container">
                                        ...
                                        $data = array("{value: ".$row['last_year'].", itemStyle: {color: '#a90000'}}", $row['jan'], $row['feb'], $row['mar'], $row['apr'], $row['may'], $row['jun'], $row['jul'], $row['aug'], $row['sep'], $row['oct'], $row['nov'], $row['dec'], round($avg, 0));
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            option = {
                                                ...
                                                xAxis: [{
                                                    type: 'category',
                                                    data: ['AVG 2021', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'AVERAGE'],
                                                    axisTick: {
                                                        alignWithLabel: true
                                                    },
                                                    axisLabel: {
