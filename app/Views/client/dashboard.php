...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-sm-inline">
            <h6 class="card-title">Overview: <span><b><?= $category ?></b></span></h6>
                        ...
                        <?php if (!empty($investDate)) : ?>
                            <?php foreach ($investDate->getResultArray() as $row) : ?>
                                ...
                                <?php if ($row['id'] == $lastInvestment->id) : ?>
                                    <option value="<?= $row['id'] ?>" selected><?= $newDate ?></option>
                                <?php else : ?>
                                    <option value="<?= $row['id'] ?>"><?= $newDate ?></option>
                                <?php endif ?>
                            <?php endforeach ?>
                        <?php endif ?>
                    </select>
        ...
        <div class="card-body d-lg-flex align-items-lg-center justify-content-lg-between flex-lg-wrap">
            ...
            <div class="d-flex align-items-center mb-3 mb-lg-0">
                ...
                <div class="ml-3">
                    <h5 class="font-weight-semibold mb-0">$ <?= ($totalUnit->total_unit != 0) ? number_format(($totalInvest->total_client_cost / $totalUnit->total_unit), 2) : "0" ?> <span class="text-success font-size-sm font-weight-normal">
