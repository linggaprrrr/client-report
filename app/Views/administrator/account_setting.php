                ...
                <div class="form-group row" style="align-items: center;">
                    ...
                    <div class="col-lg-10" style="text-align: center;">
                        <div class="card-img-actions d-inline-block">
                            ...
                            <?php else : ?>
                                <img class="img-fluid rounded-circle" id="output" src="<?= base_url() ?>/assets/images/placeholders/user.png" alt="Profile Picture" style="width:250px; height:250px;object-fit: contain;">
                            <?php endif ?>
