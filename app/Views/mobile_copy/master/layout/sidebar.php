    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section sidebar-section-body user-menu-vertical text-center pt-0">
            ...
            <div class="sidebar-resize-hide mt-2">
                <form action="<?= base_url('master/manifest') ?>" method="post">
                    ...
                    <span class="text-muted" id="set-company"><?= $user['company'] ?></span>
                </form>
            </div>
        </div>
        <!-- /user menu -->
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('/mobile/master/manifest/'. $clientSelect) ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('/mobile/master/pl-report/'. $clientSelect) ?>" class="nav-link">
